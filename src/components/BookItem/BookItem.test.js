...
describe('BookItem suite test', () => {
    ...
    it('should render book property correctly', () => {
        expect(componentInstance.findByProps({className: "book__title"}).children).toEqual([book.title]);
    });

    it('should determine if book is in store', () => {
        expect(itemIsInCart(book,cart)).toBe(true);
    });
});
